...
Устанавливаем агента на машину и просто следуем указаниям установщика. 
На этапе указания адреса сервера (Zabbix Server IP) указываем адрес нашего сервера, также его указываем и в Zabbix Server Active IP. 
В Hostname пишем имя нашего ПК и запоминаем или копируем его. 
После установки агента заходим в веб-интерфейс zabbix и добавляем Host во вкладке "Сбор данных" - "Узла сети" - "Создать узел сети". И там мы пишеи имя хоста символ в символ как указали при установке агента. Выбираем шаблон, группу и указываем интерфейс "агент" куда пишем ip-адрес хоста
---
